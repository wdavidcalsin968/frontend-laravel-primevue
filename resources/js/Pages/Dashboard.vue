            ...
            <div class="p-4 grid grid-cols-12 gap-6">
                    ...
                    <div class="p-5">
                        ...
                        <div class="ml-2 w-full flex-1">
                            <div>
                                ...
                                <div class="mt-1 text-base text-gray-600">Item 1</div>
                            </div>
                        </div>
                    </div>
                </a>
                <a class="transform  hover:scale-105 transition duration-300 shadow-xl rounded-lg col-span-12 sm:col-span-6 xl:col-span-3 intro-y bg-white"
                    ...
                    <div class="p-5">
                        ...
                        <div class="ml-2 w-full flex-1">
                            <div>
                                <div class="mt-3 text-3xl font-bold leading-8">23</div>

                                <div class="mt-1 text-base text-gray-600">Item 2</div>
                            </div>
                        </div>
                    </div>
                </a>
                    ...
                    <div class="p-5">
                        ...
                        <div class="ml-2 w-full flex-1">
                            <div>
                                ...
                                <div class="mt-1 text-base text-gray-600">Item 3</div>
                            </div>
                        </div>
                    </div>
                </a>
                <a class="transform  hover:scale-105 transition duration-300 shadow-xl rounded-lg col-span-12 sm:col-span-6 xl:col-span-3 intro-y bg-white"
                    ...
                    <div class="p-5">
                        ...
                        <div class="ml-2 w-full flex-1">
                            <div>
                                <div class="mt-3 text-3xl font-bold leading-8">64</div>

                                <div class="mt-1 text-base text-gray-600">Item 4</div>
                            </div>
                        </div>
                    </div>
                </a>
            ...
            >
                ...
                <div class="py-4 grid grid-cols-2">
                    <div class="flex gap-4">
                        <a class="transform  hover:scale-105 transition duration-300 shadow-xl rounded-lg col-span-12 sm:col-span-6 xl:col-span-3 intro-y bg-white"
                            href="#">
                            <div class="mt-3 text-xl text-center font-bold leading-8">Barra Estadistica</div>
                            <div class="p-20">
                                <Chart
                                    type="bar"
                                    :data="chartData"
                        ...
                        <a class="transform  hover:scale-105 transition duration-300 shadow-xl rounded-lg col-span-12 sm:col-span-6 xl:col-span-3 intro-y bg-white"
                            href="#">
                            <div class="mt-3 text-xl text-center font-bold leading-8">Circulo Estadistica</div>
                            <div class="p-20">
                                <Chart
                                    type="pie"
                                    :data="chartData"
